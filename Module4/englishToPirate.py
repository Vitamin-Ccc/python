import string
englishPirateDict = {"hello":"ahoy", "to":"ta", "was":"be", "cheat":"hornswaggle", "cheating":"hornswaggle'n",
...
english = input("Enter your words in English: ").lower()
...
for word in englishList:
  if word in englishPirateDict:
    pirate += englishPirateDict[word] + " "
  else:
    pirate += word + " "
